  ...
  return (
    <BottomSheet isOpen={isOpen} onClose={onClose} className="bg-bg-primary">
      <div className="flex flex-col h-[550px]">
        {/* Tabs */}
        <div className="flex border-b border-border-color px-4">
          <button 
            onClick={() => setActiveTab('DURATION')}
            className={cn(
              "flex-1 py-4 text-sm font-bold transition-all relative",
              activeTab === 'DURATION' ? "text-[#22c55e]" : "text-text-secondary"
            )}
          >
            Duration
            {activeTab === 'DURATION' && (
          ...
          <button 
            ...
            className={cn(
              ...
              activeTab === 'AMOUNT' ? "text-[#22c55e]" : "text-text-secondary"
            )}
          >
            <span className="text-[10px] text-text-secondary font-medium mb-0.5">Amount</span>
          ...
          <button 
            ...
            className={cn(
              "flex-1 py-4 text-sm font-bold transition-all relative flex flex-col items-center",
              activeTab === 'STRIKE_PRICES' ? "text-[#22c55e]" : "text-text-secondary"
            )}
          >
            <span className="text-[10px] text-text-secondary font-medium mb-0.5">Strike prices</span>
        ...
        <div className="flex-1 overflow-y-auto p-4">
          {activeTab === 'DURATION' && (
            <div className="flex flex-col items-center">
              {/* Mode Toggle */}
              <div className="flex bg-bg-secondary rounded-2xl p-1.5 w-full mb-6 border border-border-color">
                <button 
              ...
              <p className="text-text-secondary text-[11px] uppercase tracking-[0.1em] mb-6 font-bold opacity-60">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        timerDuration === option.value 
                          ...
                          : "bg-bg-secondary border-border-color text-text-secondary hover:border-[var(--color-text-primary)]/30"
                      )}
                    >
                      {option.label}
                    </button>
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            ...
                            isSelected 
                              ? "bg-[#22c55e]/10 border-[#22c55e] text-[#22c55e] shadow-[0_0_15px_rgba(34,197,94,0.1)]" 
                              : "bg-bg-secondary border-border-color text-text-primary hover:border-[var(--color-text-primary)]/30"
                          )}
                        >
          ...
          {activeTab === 'AMOUNT' && (
            <div className="flex flex-col items-center py-4">
              <p className="text-text-secondary text-[11px] uppercase tracking-[0.1em] mb-4 font-bold opacity-60">
                Investment Amount
              </p>
              
              <div className="w-full bg-bg-secondary rounded-2xl p-4 mb-8 border border-border-color flex items-center justify-between">
