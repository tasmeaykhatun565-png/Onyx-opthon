  ...
  const renderContent = () => {
    switch (title) {
      ...
      case 'Trading Tutorials':
        return (
          <div className="space-y-8">
            <h3 className="text-2xl font-bold text-white mb-4">Trading Tutorials</h3>
            <p className="text-gray-400 text-lg">Learn how to open and manage trades on the ONYX OPTION platform.</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                { title: 'Opening your first trade', desc: 'Step-by-step guide on selecting an asset, choosing the time, and making a prediction.' },
                { title: 'Using Indicators', desc: 'Explore how to add and interpret technical indicators like RSI and Bollinger Bands.' },
